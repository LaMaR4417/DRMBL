(function () {
    ...
    var CB_FALLBACK = [
        {
            division: 'Femenil', category: '2009-2010', groups: null,
            standings: [
        ...
        {
            division: 'Femenil', category: '2013-2014', groups: null,
            standings: [
        ...
        {
            division: 'Varonil', category: '2013-2014', groups: null,
            standings: [
                { slot: 'A', name: 'Betas', wins: 0, losses: 0, pointDiff: 0 },
                { slot: 'B', name: 'Leones', wins: 0, losses: 0, pointDiff: 0 },
                { slot: 'C', name: 'Spurs Monclova', wins: 0, losses: 0, pointDiff: 0 },
        ...
        {
            division: 'Varonil', category: 'Universitario', groups: null,
            standings: [
            ...
            for (var ci = 0; ci < cats.length; ci++) {
                ...
                if (groupSplit) {
                    ...
                    for (var gi = 0; gi < groupSplit.length; gi++) {
                        ...
                        // Group leader (#1) advances
                        html += buildStandingsTable(grp.standings, 1);
                        html += '</div>';
                    }
                    html += '</div>';
                } else {
                    // No groups — single table, top 2 advance
                    html += buildStandingsTable(cat.standings, 2);
                }
